...
const ChatWidget = () => {
  ...
  return (
    <div className="fixed bottom-3 right-3 sm:bottom-5 sm:right-5 z-50">
      {/* Chat Widget Window */}
      <div className={`mb-4 w-[calc(100vw-24px)] sm:w-[400px] h-[calc(100vh-100px)] sm:h-[500px] max-h-[calc(100vh-100px)] sm:max-h-[85vh] bg-gradient-to-br from-emerald-50 via-white to-blue-50 rounded-2xl shadow-2xl flex flex-col overflow-hidden border-2 border-emerald-200 transition-all duration-500 ease-in-out ${
        isOpen 
      ...
      {/* Toggle Button - Positioned relative to chat window */}
